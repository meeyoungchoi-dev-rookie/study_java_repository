...
public class ExchangeBigAndSmall {
    public static void main(String[] args) {


        ExchangeBigAndSmall ex = new ExchangeBigAndSmall();
        ...
        String result = "";
        char[] inputArray = ex.solutions(input , inputUpperArray);
    ...
    public char[] solutions(String input , char[] inputUpperArray) {
